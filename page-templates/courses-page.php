...
<div class="filter_nav">
 ...
 <?php 
$taxonomies = array('learning-type');
$args = array(
    'orderby'           => 'slug', 
    'order'             => 'ASC',
    'hide_empty'        => true, 
...
<?php $i++; } }  ?>
 ...
 <div class="mobile select_cat">
        ...
        <option value="*">All</option>
         <?php $taxonomies = array('learning-type');
            $args = array(
                'orderby'           => 'slug', 
                'order'             => 'ASC',
                'hide_empty'        => true, 
 ...
 <?php } ?>
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content application_wrapper" role="main">
        	...
        	<?php   $args = array('post_type'=> array( 'intentional-learning'),'posts_per_page'=>-1,'order_by'=>'menu_order');
                    query_posts( array_merge($args,$custom_privacy) );
				    while ( have_posts() ) : the_post(); 
                    global $post;
                    $slug = get_post( $post )->post_name;
                    
                    $il_box_platform = get_post_meta(get_the_ID(), 'il_box_platform', true);
                    $il_box_about = get_post_meta(get_the_ID(), 'il_box_about', true);
                    $il_box_link_course = get_post_meta(get_the_ID(), 'il_box_link_course', true);
                    $il_boxcheckbox = get_post_meta(get_the_ID(), 'il_boxcheckbox', true);
                    ?>
               
                    <div class="box directory_box course_box <?php $terms1 = get_the_terms( $post->ID, 'learning-type' ); foreach ( $terms1 as $term2 ) {echo $term2->slug." ";} ?>">
                        <div class="cont_box ">
                            ...
                            <?php $terms1 = get_the_terms( $post->ID, 'learning-type' ); 
                                $current_depat = array();
                            ...
                            <?php } ?>
                           	...
                           	<div id="<?php echo $slug; ?>" class="fancy_popup" style="max-width:365px;display: none;">
                                    ...
                                    <?php } ?>
                                    <?php if($il_box_link_course){ ?>
                                    <a href="<?php echo $il_box_link_course; ?>" class="couses_link" <?php if($il_boxcheckbox){ echo "target='_blank'"; } ?> >Link to Course <i class="fa fa-long-arrow-right"></i></a>
                                    <?php } ?>
